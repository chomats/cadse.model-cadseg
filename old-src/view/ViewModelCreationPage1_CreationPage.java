...
public class ViewModelCreationPage1_CreationPage extends PageImpl {
	 ...
	 * @generated
	 */
	protected ViewModelCreationPage1_CreationPage(String id, String label,
	 ...
	 * @generated
	 */
	public ViewModelCreationPage1_CreationPage(Item parent, ItemType it,
			LinkType lt) {
		super("creation-page1", "Create ViewModel", "Create ViewModel", "",
				false, 3);
		this.parent = parent;
		this.it = it;
		this.lt = lt;
