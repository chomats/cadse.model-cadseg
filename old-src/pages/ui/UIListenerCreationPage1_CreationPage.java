...
public class UIListenerCreationPage1_CreationPage extends PageImpl {
	 ...
	 * @generated
	 */
	protected UIListenerCreationPage1_CreationPage(String id, String label,
	 ...
	 * @generated
	 */
	public UIListenerCreationPage1_CreationPage(Item parent, ItemType it,
			LinkType lt) {
		super("creation-page1", "Create UIListener", "Create UIListener", "",
				false, 3);
		this.parent = parent;
		this.it = it;
		this.lt = lt;
