...
/**
 @generated
 */
public class ExtItemCreationPageExtItem_CreationPage extends PageImpl {
	...
	/**
	    @generated
	 */
	protected ExtItemCreationPageExtItem_CreationPage(String id, String label,
	...
	/**
	    @generated
	 */
	public ExtItemCreationPageExtItem_CreationPage(Item parent, ItemType it,
			LinkType lt) {
		super("creation-page-ExtItem", "Create ExtItem", "Create ExtItem", "",
				false, 3);
		this.parent = parent;
		this.it = it;
		this.lt = lt;
