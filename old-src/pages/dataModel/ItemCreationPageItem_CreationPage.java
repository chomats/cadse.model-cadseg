...
/**
 @generated
 */
public class ItemCreationPageItem_CreationPage extends PageImpl {
	...
	/**
	    @generated
	 */
	protected ItemCreationPageItem_CreationPage(String id, String label,
	...
	/**
	    @generated
	 */
	public ItemCreationPageItem_CreationPage(Item parent, ItemType it,
			LinkType lt) {
		super("creation-page-Item", "Create Item", "Create Item", "", false, 3);
		this.parent = parent;
		this.it = it;
		this.lt = lt;
