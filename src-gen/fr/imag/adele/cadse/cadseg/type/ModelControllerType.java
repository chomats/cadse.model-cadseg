...
/**
 * The Class ModelControllerType.
 * 
 * @author <a href="mailto:stephane.chomat@imag.fr">Stephane Chomat</a>
 */
public class ModelControllerType extends AEHasAttributeValue {

	/** The Constant PLUGIN_ID. */
	private static final String	PLUGIN_ID	= "Model.Workspace.Workspace";

	/** The Constant PROVIDER. */
	private static final String	PROVIDER	= "model_controller";

	/**
	 * Instantiates a new model controller type.
	 * 
	 * @param ce
	 *            the ce
	 */
	public ModelControllerType(IConfigurationElement ce) {
		super(ce);
	}
	...
	public String getUserControllerInterface() {
		...
		if (value == null) {
			ModelControllerType superUI = (ModelControllerType) getSuper();
			if (superUI != null)
	...
	public static void registerProvider() {
		...
		types = new HashMap<String, ModelControllerType>();
		for (int i = 0; i < extensions.length; i++) {
			IConfigurationElement[] ce = extensions[i].getConfigurationElements();
			for (int j = 0; j < ce.length; j++) {
				ModelControllerType at = new ModelControllerType(ce[j]);
				register(at);
			}
		}
	}
	...
	/** The types. */
	static Map<String, ModelControllerType>	types	= null;
	 ...
	 *            the at
	 */
	private static void register(ModelControllerType at) {
	 ...
	 * @return the types
	 */
	public static ModelControllerType[] getTypes() {
		return (ModelControllerType[]) types.values().toArray(new ModelControllerType[types.values().size()]);
	}
	 ...
	 */
	public static ModelControllerType getTypeFromString_(String name) {
		if (name == null)
			return null;
		if (types == null)
			registerProvider();
	...
	// if (o!= null) fd.put(IFieldDescription.MODEL_CONTROLLER, o);
	// }
}