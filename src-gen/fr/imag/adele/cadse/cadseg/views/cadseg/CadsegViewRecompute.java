 ...
 * @generated
 */
class CadsegViewRecomputeUI extends AbstractCadseTreeViewUI {

	/**
	 * @generated
	 */
	public CadsegViewRecomputeUI(IViewSite site) {
		super(site);
...
/**
 * The Class CadsegViewRecompute.
 * 
 * @author <a href="mailto:stephane.chomat@imag.fr">Stephane Chomat</a>
 */
public class CadsegViewRecompute extends AbstractCadseView {
	...
	protected AbstractCadseTreeViewUI createUIController(IViewSite site) {
		return new CadsegViewRecomputeUI(site);
	}
