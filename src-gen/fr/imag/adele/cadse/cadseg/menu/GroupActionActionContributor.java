...
public class GroupActionActionContributor implements IActionContributor {
	...
	private void insertNewAction(ViewDescription viewDescription, Menu menu, ItemType gt, ItemType gtType,
			LinkType glt, ItemType destinationType, IItemNode n) {
		...
		if (!viewDescription.filterNew(c)) {
			menu.insert(null, new MenuNewAction((IShellProvider) viewDescription.getWindowProvider(), c, gt
					.getDisplayName()
					+ " " + destinationType.getDisplayName()), true);
		}
