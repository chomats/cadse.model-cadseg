...
public abstract class ExpressionParse implements ExpressionParseConstants {
	...
	protected void setExp(ExpToken t) {
		exp = t;
	}
		...
		label_1: while (true) {
			switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
				...
				case CST_SEP:
					...
					t.image = removeAntiSlash(t.image.substring(1, t.image.length() - 1));
					ret.add(t);
					break;
				case CST:
					t = jj_consume_token(CST);
					t.image = removeAntiSlash(t.image);
					ret.add(t);
					break;
				default:
					jj_la1[0] = jj_gen;
