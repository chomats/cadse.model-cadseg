...
/**
 * The Class StringToOneResourceModelControllerManager.
 * 
...
//				"Create a string to one resource model controller", "Create a string to one resource model controller",
//				3));
//	}
//
//	/*
...
//
//		return FieldsCore.createWizard(action, FieldsCore.createPage("page1",
//				" a string to one resource model controller", "a string to one resource model controller", 3));
//	}
