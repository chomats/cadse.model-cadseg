...
/**
 @generated
 */
public class CadseModificationPage1_ModificationPage extends PageImpl {
	...
	/**
	    @generated
	 */
	protected CadseModificationPage1_ModificationPage(String id, String label,
	...
	/**
	    @generated
	 */
	public CadseModificationPage1_ModificationPage(Item item) {
	...
	public DListUI createFieldItemTypes() {
		...
		LinkModelController mc = new LinkModelController(false, null,
				CadseGCST.CADSE_lt_ITEM_TYPES);
		return new DListUI(CadseGCST.CADSE_lt_ITEM_TYPES.getName(),
	...
	public DListUI createFieldExtends() {
		...
		LinkModelController mc = new LinkModelController(false, null,
				CadseGCST.CADSE_lt_EXTENDS);
		return new DListUI(CadseGCST.CADSE_lt_EXTENDS.getName(), "extends",
	...
	public DCheckBoxUI createFieldExecuted() {
		...
		return new DCheckBoxUI(CadseGCST.CADSE_at_EXECUTED, "executed",
