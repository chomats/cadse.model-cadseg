...
public class ViewItemTypeCreationPage1_CreationPage extends PageImpl {
	 ...
	 * @generated
	 */
	protected ViewItemTypeCreationPage1_CreationPage(String id, String label,
	 ...
	 * @generated
	 */
	public ViewItemTypeCreationPage1_CreationPage(Item parent, ItemType it,
			LinkType lt) {
		super("creation-page1", "Create ViewItemType", "Create ViewItemType",
				"", false, 3);
		this.parent = parent;
		this.it = it;
		this.lt = lt;
