 ...
 * @generated
 */
public class ExporterModificationPage1_ModificationPage extends PageImpl {
	 ...
	 * @generated
	 */
	public ExporterModificationPage1_ModificationPage(Item item) {
		super("modification-page1", "Exporter", "Exporter", "", false, 3);
		this.item = item;
		this.fieldTypes = createFieldTypes();
		setActionPage(null);
		addLast(this.fieldTypes);
