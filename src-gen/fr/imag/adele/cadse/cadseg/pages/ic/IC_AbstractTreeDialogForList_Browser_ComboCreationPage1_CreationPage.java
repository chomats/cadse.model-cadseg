 ...
 * @generated
 */
public class IC_AbstractTreeDialogForList_Browser_ComboCreationPage1_CreationPage
		extends InteractionControllerCreationPage1_CreationPage {
	 ...
	 * @generated
	 */
	protected IC_AbstractTreeDialogForList_Browser_ComboCreationPage1_CreationPage(
	 ...
	 * @generated
	 */
	public IC_AbstractTreeDialogForList_Browser_ComboCreationPage1_CreationPage(
			Item parent, ItemType it, LinkType lt) {
		super("creation-page1",
				"Create IC_AbstractTreeDialogForList_Browser_Combo",
				"Create IC_AbstractTreeDialogForList_Browser_Combo", "", false,
				3);
		this.parent = parent;
		this.it = it;
		this.lt = lt;
