...
/**
 @generated
 */
public class UIValidatorCreationPageUIValidator_CreationPage extends PageImpl {
	...
	/**
	    @generated
	 */
	protected UIValidatorCreationPageUIValidator_CreationPage(String id,
	...
	/**
	    @generated
	 */
	public UIValidatorCreationPageUIValidator_CreationPage(Item parent,
			ItemType it, LinkType lt) {
		super("creation-page-UIValidator", "Create UIValidator",
				"Create UIValidator", "", false, 3);
		this.parent = parent;
		this.it = it;
		this.lt = lt;
