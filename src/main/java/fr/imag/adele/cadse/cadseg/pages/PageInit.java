...
public class PageInit {
	...
	public static void init() throws CadseException {
		...
		CadseGCST.ITEM_TYPE_at_IS_INSTANCE_ABSTRACT_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.ATTRIBUTE_at_CANNOT_BE_UNDEFINED_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, false);
		...
		CadseGCST.ATTRIBUTE_at_IS_LIST_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.ATTRIBUTE_at_TWREV_SPECIFIC_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.ATTRIBUTE_at_DEFAULT_VALUE_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_AGGREGATION_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_ANNOTATION_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_COMPOSITION_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_GROUP_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_HIDDEN_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_MAPPING_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_MAX_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_MIN_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_SELECTION_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, false);
		CadseGCST.LINK_TYPE_at_PART_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_REQUIRE_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_TWDEST_EVOL_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_at_TWCOUPLED_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_lt_DESTINATION.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.LINK_TYPE_lt_INVERSE_LINK.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, false);
		CadseGCST.LINK_TYPE_lt_INVERSE_LINK.setFlag(Item.CAN_BE_UNDEFINED, true);
		CadseGCST.LINK_TYPE_lt_SOURCE.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, false);
		CadseGCST.LINK_TYPE_at_KIND_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.LINK_TYPE_at_KIND_.setFlag(Item.CAN_BE_UNDEFINED, true);
		CadseGCST.ENUM_lt_ENUM_TYPE.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.ENUM_TYPE_at_VALUES_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.PROJECT_CONTENT_MODEL_at_PROJECT_NAME_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.JAVA_PROJECT_CONTENT_MODEL_at_HAS_SOURCE_FOLDER_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME,
				true);
		CadseGCST.RUNTIME_ITEM_at_EXTENDS_CLASS_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.FILE_CONTENT_MODEL_at_FILE_PATH_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.CONTENT_ITEM_TYPE_at_EXTENDS_CLASS_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.ENUM_at_ENUM_CLAZZ_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ENUM_at_VALUES_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ATTRIBUTE_at_DEV_GENERATED_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ATTRIBUTE_at_ID_RUNTIME_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ATTRIBUTE_lt_WC_LISTENS.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_at_ID_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_at_ISVALID_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_at_ITEM_HIDDEN_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_at_ITEM_READONLY_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_lt_CONTENTS.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_lt_INSTANCE_OF.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_lt_PARENT.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_lt_LINK_TYPE.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_at_CUSTOM_MANAGER_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_at_DISPLAY_NAME_TEMPLATE_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_at_HAS_SHORT_NAME_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_at_HAS_UNIQUE_NAME_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_at_ITEM_MANAGER_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_at_MANAGER_CLASS_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_at_MESSAGE_ERROR_ID_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_at_OVERWRITE_DEFAULT_PAGES_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_at_QUALIFIED_NAME_TEMPLATE_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_at_VALIDATE_NAME_RE_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_lt_SUB_TYPES.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ITEM_TYPE_lt_WC_LISTENERS.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.TYPE_DEFINITION_lt_ATTRIBUTES.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.TYPE_DEFINITION_at_ID_RUNTIME_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.TYPE_DEFINITION_lt_CADSE.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.TYPE_DEFINITION_lt_CREATION_PAGES.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.TYPE_DEFINITION_lt_FIELDS.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.TYPE_DEFINITION_lt_GOUPS_OF_ATTRIBUTES.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.TYPE_DEFINITION_lt_MODIFICATION_PAGES.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.TYPE_DEFINITION_lt_VALIDATORS.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.CADSE_DEFINITION_at_ID_RUNTIME_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.CADSE_DEFINITION_lt_BUILD.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.CADSE_DEFINITION_lt_CONFIGURATION.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.CADSE_DEFINITION_lt_DATA_MODEL.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.CADSE_DEFINITION_lt_MAPPING.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.CADSE_DEFINITION_lt_VIEW_MODEL.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.CADSE_at_ID_DEFINITION_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.CADSE_lt_ITEM_TYPES.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.CADSE_at_EXECUTED_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.MANAGER_at_DISPLAY_NAME_TEMPLATE_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.MANAGER_at_ICON_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.MANAGER_at_MESSAGE_ERROR_ID_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.MANAGER_at_QUALIFIED_NAME_TEMPLATE_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.MANAGER_at_VALID_PATTERN_ID_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.MANAGER_lt_CONTENT_MODEL.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.MANAGER_lt_EXPORTERS.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.MANAGER_lt_ITEM_TYPE.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.JAVA_PROJECT_CONTENT_MODEL_lt_CONTENT_MODEL.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.FOLDER_CONTENT_MODEL_lt_CONTENT_MODEL.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.FOLDER_CONTENT_MODEL_at_FOLDER_PATH_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, false);
		CadseGCST.FOLDER_CONTENT_MODEL_at_FOLDER_PATH_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.JAVA_FILE_CONTENT_MODEL_at_CLASS_NAME_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.JAVA_FILE_CONTENT_MODEL_at_PACKAGE_NAME_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, true);
		CadseGCST.ITEM_TYPE_at_DEFAULT_INSTANCE_NAME_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, false);
		CadseGCST.ITEM_TYPE_at_DEFAULT_INSTANCE_NAME_.setFlag(Item.MUST_BE_INITIALIZED_AT_CREATION_TIME, false);
		CadseGCST.ATTRIBUTE_at_FINAL_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
		CadseGCST.ATTRIBUTE_at_REQUIRE_.setFlag(Item.HIDDEN_IN_COMPUTED_PAGES, true);
