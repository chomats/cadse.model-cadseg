...
public class PageInit {
	public static void init() throws CadseException {
		...
		// create destination field (overwrite ic)
		{
			...
			CadseGCST.LINK_TYPE.addField(new UIFieldImpl(
				CadseGCST.DBROWSER, UUID.randomUUID(),CadseGCST.LINK_TYPE_lt_DESTINATION,
		...
		{// create destination field (overwrite ic)
			...
			CadseGCST.LINK_TYPE.addField(new UIFieldImpl(
					CadseGCST.DBROWSER, UUID.randomUUID(),CadseGCST.LINK_TYPE_lt_INVERSE_LINK,
		...
		}
		{
			...
			CadseGCST.LINK_TYPE.addField(new UIFieldImpl(
					CadseGCST.DTEXT, UUID.randomUUID(),CadseGCST.LINK_TYPE_at_MIN_,
					"min:", EPosLabel.left,
		...
		
		{
			...
			CadseGCST.LINK_TYPE.addField(new UIFieldImpl(
					CadseGCST.DTEXT, UUID.randomUUID(),CadseGCST.LINK_TYPE_at_MAX_,
					"max:", EPosLabel.left,
					mc, icMax));
		}
		{
