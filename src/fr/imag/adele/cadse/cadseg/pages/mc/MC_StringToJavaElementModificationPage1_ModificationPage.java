...
public class MC_StringToJavaElementModificationPage1_ModificationPage extends
	 ...
	 * @generated
	 */
	protected MC_StringToJavaElementModificationPage1_ModificationPage(String id, String label, String title,
	...
	public MC_StringToJavaElementModificationPage1_ModificationPage(Item item) {
		super("modification-page1", "MC_StringToJavaElement", "MC_StringToJavaElement", "", false, 3);
		this.item = item;
