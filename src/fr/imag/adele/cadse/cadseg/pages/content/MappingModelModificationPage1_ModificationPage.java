...
public class MappingModelModificationPage1_ModificationPage extends PageImpl {
	 ...
	 * @generated
	 */
	protected MappingModelModificationPage1_ModificationPage(String id, String label, String title, String description,
	...
	public MappingModelModificationPage1_ModificationPage(Item item) {
		super("modification-page1", "MappingModel", "MappingModel", "", false, 3);
		this.item = item;
	...
	public DListUI createFieldManagers() {
		LinkModelController mc = new LinkModelController(false, null, WorkspaceCST.MAPPING_MODEL_lt_MANAGERS);
		...
		return new DListUI(WorkspaceCST.MAPPING_MODEL_lt_MANAGERS.getName(), "managers", EPosLabel.top, mc, ic, true,
				false, false, false);
	}
