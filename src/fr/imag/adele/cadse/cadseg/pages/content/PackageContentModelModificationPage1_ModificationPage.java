...
public class PackageContentModelModificationPage1_ModificationPage extends
	 ...
	 * @generated
	 */
	protected PackageContentModelModificationPage1_ModificationPage(String id, String label, String title,
	...
	public PackageContentModelModificationPage1_ModificationPage(Item item) {
		super("modification-page1", "PackageContentModel", "PackageContentModel", "", false, 3);
		this.item = item;
