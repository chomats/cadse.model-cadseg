...
public class IC_AbstractForListModificationPage1_ModificationPage extends
	 ...
	 * @generated
	 */
	protected IC_AbstractForListModificationPage1_ModificationPage(String id, String label, String title,
	...
	public IC_AbstractForListModificationPage1_ModificationPage(Item item) {
		super("modification-page1", "IC_AbstractForList", "IC_AbstractForList", "", false, 3);
		this.item = item;
