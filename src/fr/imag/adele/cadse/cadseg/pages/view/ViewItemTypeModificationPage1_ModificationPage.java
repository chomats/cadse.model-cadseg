...
public class ViewItemTypeModificationPage1_ModificationPage extends PageImpl {
	 ...
	 * @generated
	 */
	protected ViewItemTypeModificationPage1_ModificationPage(String id, String label, String title, String description,
	...
	public ViewItemTypeModificationPage1_ModificationPage(Item item) {
		super("modification-page1", "ViewItemType", "ViewItemType", "", false, 3);
		this.item = item;
		...
		setActionPage(null);
		addLast(this.__short_name__, this.fieldViewLinkTypes, this.fieldItemType, this.fieldRef,
	...
	public DListUI createFieldViewLinkTypes() {
		...
		return new DListUI(WorkspaceCST.VIEW_ITEM_TYPE_lt_VIEW_LINK_TYPES.getName(), "view-link-types", EPosLabel.top,
	...
	public DBrowserUI createFieldItemType() {
		LinkModelController mc = new LinkModelController(true, null, WorkspaceCST.VIEW_ITEM_TYPE_lt_ITEM_TYPE);
		IC_LinkForBrowser_Combo_List ic = new IC_LinkForBrowser_Combo_List("Select a value.", "Select a value.",
				WorkspaceCST.VIEW_ITEM_TYPE_lt_ITEM_TYPE);
		return new DBrowserUI(WorkspaceCST.VIEW_ITEM_TYPE_lt_ITEM_TYPE.getName(), "item-type", EPosLabel.left, mc, ic);
	}
	...
	public DCheckBoxUI createFieldRef() {
		...
		return new DCheckBoxUI(WorkspaceCST.VIEW_ITEM_TYPE_at_REF, "ref", EPosLabel.none, mc, null);
	}
	...
	public DCheckBoxUI createFieldIsRootElement() {
		StringToBooleanModelControler mc = new StringToBooleanModelControler();
		return new DCheckBoxUI(WorkspaceCST.VIEW_ITEM_TYPE_at_IS_ROOT_ELEMENT, "is-root-element", EPosLabel.none, mc,
				null);
	}
