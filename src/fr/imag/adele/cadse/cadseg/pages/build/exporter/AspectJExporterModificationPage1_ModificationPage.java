...
public class AspectJExporterModificationPage1_ModificationPage extends
	 ...
	 * @generated
	 */
	protected AspectJExporterModificationPage1_ModificationPage(String id, String label, String title,
	...
	public AspectJExporterModificationPage1_ModificationPage(Item item) {
		super("modification-page1", "AspectJExporter", "AspectJExporter", "", false, 3);
		this.item = item;
