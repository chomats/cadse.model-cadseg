...
public class AttributeEvolDef_CreationPage extends PageImpl {
	 ...
	 * @generated
	 */
	protected AttributeEvolDef_CreationPage(String id, String label, String title, String description,
	...
	public AttributeEvolDef_CreationPage(Item parent, ItemType it, LinkType lt) {
		super("evol-def", "Evolutions definition", "Evolutions definition", "Set the evolutions definition", false, 3);
		this.parent = parent;
		this.it = it;
		this.lt = lt;
