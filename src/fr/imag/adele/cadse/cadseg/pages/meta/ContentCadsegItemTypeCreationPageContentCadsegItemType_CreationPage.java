...
/**
 @generated
 */
public class ContentCadsegItemTypeCreationPageContentCadsegItemType_CreationPage
		extends PageImpl {
	...
	/**
	    @generated
	 */
	protected ContentCadsegItemTypeCreationPageContentCadsegItemType_CreationPage(
	...
	/**
	    @generated
	 */
	public ContentCadsegItemTypeCreationPageContentCadsegItemType_CreationPage(
			Item parent, ItemType it, LinkType lt) {
		super("creation-page-ContentCadsegItemType",
				"Create ContentCadsegItemType", "Create ContentCadsegItemType",
				"", false, 3);
		this.parent = parent;
		this.it = it;
		this.lt = lt;
